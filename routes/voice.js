...
/*We also create a TwimlResponse object that 
we will use to build up a string of XML we 
can ultimately render as a response to Twilio's request.*/
exports.interview = function(request, response) {
	...
	SurveyResponse.advanceSurvey({
			...
			if(!question) { 
				say('Thank you for requesting a ride. We will callback upon confirmation!');
				return respond();
			}
